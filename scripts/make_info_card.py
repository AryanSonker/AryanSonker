...
# ===========================================================================
HOST = "aryan"   # shown as  aryan@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Software Engineer @ Western Union"),
    ("kv", "Prev", "Backend Engineer Intern @ Cashfree Payments"),
    ("kv", "Also", "Junior Associate · Backend Developer"),
    ("kv", "Edu", "B.Tech CSE, Harcourt Butler '23"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "Java 17, Spring Boot 3, Microservices"),
    ("kv", "Data", "PostgreSQL, MySQL, Couchbase, Kafka"),
    ("kv", "Patterns", "Saga, Circuit Breaker, OAuth2/JWT"),
    ("kv", "DevOps", "Docker, GitLab CI, Jenkins, SonarQube"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Payment microservices processing millions of daily transactions"),
    ("bul", "95% test coverage; cut production defects by 30%"),
    ("bul", "Migrated CI/CD to GitLab, zero-downtime deploys, -25-30% cost"),
]
